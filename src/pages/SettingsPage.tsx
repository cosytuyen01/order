  ...
  return (
    <div className="min-h-screen">
      <div className="px-4 pb-2 pt-[max(1rem,env(safe-area-inset-top))]">
        <div
          className="relative overflow-hidden rounded-3xl px-4 pb-4 pt-3 text-white shadow-[0_18px_44px_-20px_rgba(61,35,20,0.75)]"
          style={{
            backgroundImage: `linear-gradient(120deg, rgba(61,35,20,0.9), rgba(61,35,20,0.42)), url('/bg_profile.png')`,
        ...
        >
          {isOwner && (
            <button
              ...
              className="absolute right-4 top-4 rounded-full bg-white/95 px-4 py-2 text-xs font-semibold text-brown shadow-sm"
            >
          ...
          <div className="mt-10 flex items-center gap-3">
            <StoreLogo
              ...
              size="lg"
              className="border-white/40 bg-white/20 text-white shadow-none"
            />
            <div className="min-w-0 flex-1">
              ...
              <p className="mt-1 flex items-center gap-1 truncate text-sm text-amber-50/95">
          ...
          <div className="mt-2.5 flex gap-2">
            <div className="inline-flex items-center gap-1 rounded-full border border-white/25 bg-white/10 px-2.5 py-1 text-xs text-amber-50">
          ...
          <p className="mt-3 text-xs text-amber-50/90">
            Quản lý tài khoản, thông báo và cài đặt cửa hàng.
          </p>
        </div>
      </div>
